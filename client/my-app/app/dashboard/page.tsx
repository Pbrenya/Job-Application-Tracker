          ...
          <div className="jt-page__head">
            <div>
              ...
              <p className="jt-page__subtitle">
                Quick overview of your job search momentum.
              </p>
            </div>
          </div>
          ...
          {!loading ? (
            <div className="jt-grid jt-grid--3">
              <div className="jt-card jt-card--lavender">
                <div className="jt-card__title">Total applications</div>
                <div className="jt-card__value">{stats.totalApplications}</div>
              </div>
              <div className="jt-card jt-card--mint">
                <div className="jt-card__title">By stage</div>
              ...
              <div className="jt-card jt-card--peach">
                <div className="jt-card__title">Top companies</div>
                <div className="jt-list">
